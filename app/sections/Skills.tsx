...
import pythonlogo from "@/app/assets/python.png"
...
import djangoicon from "@/app/assets/django.png"
    ...
    <section className="mt-16 px-2">
        <div className="container sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto 2xl:mx-auto">
            ...
            <div className="hidden lg:flex lg:gap-4 lg:flex-wrap mt-6 lg:justify-center mb-2">
                ...
                <Card className="cursor-pointer w-1/6 flex items-center flex-col py-2 sm:px-2 sm:py-4">
                  <CardContent>
                    <Image width={50}  className="mx-auto sm:w-[70px]" src={pythonlogo} alt="node icon"></Image>
                  </CardContent>
                    <CardFooter>
                ...
                <Card className="cursor-pointer w-1/6 flex items-center flex-col py-2 sm:px-2 sm:py-4">
                  <CardContent>
                    <Image width={50} className="mx-auto sm:w-[70px]" src={djangoicon} alt="react native icon"></Image>
                  </CardContent>
                    <CardFooter>
